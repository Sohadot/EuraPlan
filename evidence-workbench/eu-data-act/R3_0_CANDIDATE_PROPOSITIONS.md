...
| R-B2 | "Related service" = a digital service (other than an electronic communications service), incl. software, **either** connected at purchase/rent/lease such that its absence would prevent a product function, **or subsequently connected by the manufacturer or a third party to add to, update or adapt** the product's functions | Art. 2 (def.) | — | — | definition | covers **later-connected** services, not only those bundled at purchase | — | Bundled *and* after-market software scoping — over-narrow reading would under-scope the route | CAND-01 | candidate |
...
| R-B5 | Chapter II obligations **do not apply** to data generated by connected products **manufactured or designed**, or related services **provided**, by a **microenterprise or small enterprise** | Art. 7(1) | the **enterprise that manufactures/designs the connected product or provides the related service** (micro/small) — *not* necessarily "the data holder" | enterprise qualifies as micro/small | scope-limit | only if that enterprise has **no partner/linked enterprise** that is not micro/small, and the product/service is **not sub-contracted** to it by a larger enterprise | applicable | SME status changes exposure to Ch II | CAND-01 | split-needed |
| R-B5b | The exemption **also** covers products/services of an enterprise that has qualified as **medium-sized for less than one year**, and connected products **for one year after** they were placed on the market by a medium-sized enterprise | Art. 7(1) subpara. | recently-grown / medium-sized enterprise | recent size transition / product age <1yr | scope-limit (transitional) | time-boxed grace, not a permanent exemption | applicable | **Scale-up grace window** — a firm crossing the size threshold is not instantly in scope; roadmap timing input | CAND-01 | candidate (companion to R-B5) |
| R-B6 | The Regulation is **without prejudice to** Union/national law on personal-data protection, privacy and confidentiality of communications; **in the event of conflict, the personal-data/privacy law prevails** | Art. 1(5) | all actors | conflict with data-protection/privacy law | scope-boundary | GDPR / ePrivacy prevail on their layer | applicable | **GDPR interface — do not merge authorities** (→ seam S6) | CAND-01 (+CAND-10 context) | split-needed |
| R-B6b | The Data Act **creates no legal basis** for processing personal data; where the **user is not the data subject**, a data holder/third party may make available / receive personal data only under a **valid GDPR legal basis** | Arts. 4(12) & 5(7) ⚠ verify | data holder / third-party recipient | personal data + user ≠ data subject | prohibition / condition | GDPR Art. 6 (and Art. 9) basis required | applicable | Stops the access right being misread as a personal-data gateway (recital 7 interprets but does not found this) | CAND-01 (+CAND-10) | candidate |
| R-B7 | A contractual term that, **to the user's detriment**, excludes, derogates from or varies the user's Chapter II rights is **not binding on the user** (anti-waiver) | Art. 7(2) | contracting parties | term detrimental to user's Ch II rights | prohibition (unenforceability) | — | applicable | User access rights cannot be contracted away — contract-review checkpoint | CAND-01 | candidate |
...
| R-K2 | Member States lay down **penalties** that are effective, proportionate and dissuasive; **separately**, for infringements of the obligations in **Chapters II, III and V**, the **supervisory authorities responsible under GDPR (2016/679) may, within their competence, impose administrative fines under GDPR Art. 83 up to the Art. 83(5) amount** | Art. 40(1) & **40(4)** | national penalty regime; **GDPR supervisory authorities** for the Art. 40(4) route | infringement (40(4): of Ch. II/III/V, within GDPR-SA competence) | qualifier / cross-reference | 40(4) is **not** "any personal-data infringement" — it is tied to Ch. II/III/V **and** to GDPR-SA competence | applicable | Risk framing — cite the Chapter-scoped GDPR-fine route accurately, avoid scare copy | CAND-01 (+CAND-10) | split-needed |
...
| R-K5 | **Savings clause:** pre-existing sectoral Union acts on data access/use (in force on/before 11.1.2024) **remain unaffected**; the Data Act is without prejudice to more specific Union acts imposing further requirements, and (except Chapter V) to Union/national law on data access for **scientific research** | Art. 44 | all actors | overlap with sectoral / research law | boundary rule | sectoral acts prevail/complement; research carve-out excludes Ch. V | applicable | Data Act is a **general** layer under sector-specific law — do not read it as overriding sectoral data regimes (distinct from the GDPR boundary in R-B6) | CAND-01 | candidate |
...
| Q2 | R-C1/R-C3/R-C6 access & sharing duties | R-B5 micro/small exemption **+ R-B5b transitional grace** (Art. 7(1)) | obligation + exemption |
...
| Q15 | R-C1/R-C3/R-C6 user Ch. II rights | R-B7 anti-waiver — detrimental terms not binding (Art. 7(2)) | right + non-derogation |
| Q16 | R-C6 sharing / R-D1 third-party use | R-B6b no legal basis; GDPR basis required where user ≠ data subject (Arts. 4(12)/5(7)) | right + personal-data condition |
...
|---|---|---|---|---|
| I — General provisions | 1–2 | ✅ | ✅ R-B1…B7 (incl. B5b, B6b), R-A1 | Art. 1(5) conflict-prevalence + related-service (later-connected) def **confirmed**; verify Art. 2 definition numbers + Arts. 4(12)/5(7) legal-basis wording |
| II — B2C/B2B data sharing | 3–7 | ✅ | ✅ R-C1…C7, R-D1…D2, R-B5/B5b/B7 | Densest claim area; Art. 7 micro/small **+ medium-sized transitional grace + Art. 7(2) anti-waiver captured**; Art. 4/5 locators + trade-secret conditions still to falsify |
...
| IX — Implementation & enforcement | 37–42 | ✅ | ✅ R-K1…K3 | Art. 40(4) GDPR-fine route **confirmed** as Chapter II/III/V-scoped + GDPR-SA competence (not "any personal-data infringement"); Arts. 41–42 defer |
| X — Sui generis DB right | 43 | ✅ | ✅ R-K4 | Confirm exact carve-out wording vs Directive 96/9/EC |
| XI — Final provisions | 44–50 | ✅ | ✅ R-A2…A7, R-K5 | Art. 50 dates load-bearing; Art. 44 **confirmed** = sectoral/research savings clause (the GDPR conflict rule is Art. 1(5) → R-B6, not Art. 44); Arts. 45–48 reject/defer |
