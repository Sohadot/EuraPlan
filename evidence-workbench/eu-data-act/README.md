...
| R3.5 | Page Transformation | **COMPLETE / staged** — six-layer decision surface rendered and reviewed as `release-candidate/index.html` (`robots: noindex`, live page untouched) |
