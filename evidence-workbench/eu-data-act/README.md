...
**Status:** **R3.0 CLOSED/PASS · R3.1 CLOSED/PASS · R3.2 COMPLETE (workbench) · R3.3 IN PROGRESS (Blocks 1–3 done)** — R3.1 falsified Arts 1–50 (R3.1-F Q1–Q16+N1–N7 PASS). **R3.2 (DEC-060): 87 identities `EP-CLM-000046..000132` + `EP-SRC-000006/000007` minted — all `draft`, workbench-internal, no public claims.json.** **R3.3 (verbatim vs EP-SRC-000006): A=Block 1 `…046..051` (Arts 1/3(1)/44/50); B=Block 2 `…052..061` (Arts 1(5)/2/4(12)/5(7)/7 — definitions & boundaries); C=Block 3 `…062..071` (Arts 3/4/5/6(1) — Ch II access defaults + carve-outs). 26/26 `VERIFIED_LITERAL`; corrigendum no-effect (Art 48 only); `last_verified_at=2026-08-31`; `validity_state` null, `published` false — see `R3_3_VERBATIM_VERIFICATION.md`.** **Next: R3.3-D — Block 4 (Data-holder availability Ch III, `EP-CLM-000072..000079`; begins at D2/`…072`, C6's Q4 fwd-dep).** No live mutation. Freshness Gate + Publish Gate NOT OPEN.  
...
| R3.3 | Human Literal Verification | **IN PROGRESS** — A=Block 1 (`…046..051`, Arts 1/3(1)/44/50) **6/6** · B=Block 2 (`…052..061`, Arts 1(5)/2/4(12)/5(7)/7) **10/10** · C=Block 3 (`…062..071`, Arts 3/4/5/6(1)) **10/10** VERIFIED_LITERAL (`R3_3_VERBATIM_VERIFICATION.md`); Blocks 4–10 PENDING (D2/`…072` begins R3.3-D) |
