...
**Status:** **R3.0 CLOSED / PASS · R3.1 IN PROGRESS** — R3.1-A reviewed (PASS) · R3.1-B reviewed · **R3.1-C (Ch. IV–V + Ch. III coverage-delta) complete, awaiting review** · R3.1-D next. No claims minted. No live mutation. Publish Gate NOT OPEN.  
...
| R3.1 | Claim Map & Falsification | **IN PROGRESS** — R3.1-A reviewed (PASS) · R3.1-B reviewed · R3.1-C (Ch. IV–V + Ch. III coverage-delta) complete, awaiting review · R3.1-D/-E/-F pending |
