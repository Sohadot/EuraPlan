...
**Status:** Internal — Sprint 2A Evidence Record (frozen)
**Asset:** EuraPlan.com
...
**Governed by:** REFERENCE_SOVEREIGNTY_DOCTRINE.md, FRESHNESS_ENGINE.md, EVIDENCE_GRAPH_MODEL.md, CLAIM_IDENTITY_AND_LIFECYCLE_SPECIFICATION.md, SOURCE_POLICY.md
...
| # | Item | Status | Action |
|---|---|---|---|
| A14 | New prohibited practices Art 5(1)(ba) (non-consensual intimate imagery) and (bb) (CSAM), plus Art 5(1a)/(1b), apply from **2 December 2026**, per Article 113 third paragraph point (a) as amended by 2026/1744 | **confirmed** (corrected from earlier ambiguous) | addition (mint in 2B) |
...
| A16 | Articles 102–110 of the AI Act apply from **27 July 2026** (further amendment inside Article 113) | confirmed substance; **exact locator pending verbatim capture** | addition (mint in 2B after locator) |
...
4. **Literal amending-provision locators** (which point of 2026/1744 amends Article 113; exact point-lettering of the amended Article 113 third paragraph; the Articles 102–110 / 27 Jul 2026 locator) were **not verbatim-captured** at audit time — the EUR-Lex document exceeded the fetch tool's readable window. Verbatim locator capture is a precondition for minting in Sprint 2B and is not yet complete.

## 6. Publication-exposure note
`robots.txt` `Disallow: /internal/` prevents compliant crawling only — it is not an access barrier. If the deployment serves this branch's files by URL, this record remains directly fetchable though unindexed. Its content is analysis of public law and the public site, so "unindexed but potentially public" is acceptable. If "never public" is required, the build/deploy must exclude the `internal/` path at source, not rely on `robots.txt`.

---

*EuraPlan.com — Internal Sprint 2A Evidence Record. Not a published reference page. A# identifiers are non-citable.*
